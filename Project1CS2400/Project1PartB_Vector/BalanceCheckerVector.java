...
public class BalanceCheckerVector {
	
	
	public static boolean checkBalance(String expression) {
		VectorImplementation<Character> my = new VectorImplementation<>();
		int index = 0;
...
// checking cases
	...
	public static void captureOp(Pres firstOp,VectorImplementation my,StringBuilder postFix) {
		while (!my.isEmpty()) {
